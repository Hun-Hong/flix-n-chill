...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='review',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='likes', to='movies.review'),
        ),
        migrations.AddField(
            model_name='reviewlike',
            name='user',
        ...
        migrations.AddField(
            model_name='user',
            name='like_movie',
            field=models.ManyToManyField(blank=True, related_name='liked_user', through='accounts.MovieLike', to='movies.movie'),
        ),
        migrations.AddField(
            model_name='user',
